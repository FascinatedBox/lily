...
void lily_move_dynamic(lily_value *, lily_container_val *);
...
void lily_move_instance_f(uint32_t, lily_value *, lily_container_val *);
void lily_move_integer(lily_value *, int64_t);
void lily_move_list_f(uint32_t, lily_value *, lily_container_val *);
void lily_move_string(lily_value *, lily_string_val *);
void lily_move_tuple_f(uint32_t, lily_value *, lily_container_val *);
void lily_move_unit(lily_value *);
void lily_move_variant_f(uint32_t, lily_value *, lily_container_val *);
