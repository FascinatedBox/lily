# ifndef LILY_TYPE_STACK_H
# define LILY_TYPE_STACK_H
# include "lily_core_types.h"
# include "lily_raiser.h"
# include "lily_symtab.h"

/* lily_type_stack is a container for type information that is used by
...
int lily_ts_check(lily_type_stack *, lily_type *, lily_type *);
...
lily_type *lily_ts_easy_resolve(lily_type_stack *, lily_type *);
...
lily_type *lily_ts_resolve(lily_type_stack *, lily_type *);
...
lily_type *lily_ts_resolve_by_second(lily_type_stack *, lily_type *, lily_type *);
...
/* This is called to fill in generics directly, in the event that the first
   ...
   [A, C]). */
void lily_ts_resolve_as_variant_by_enum(lily_type_stack *, lily_type *, lily_type *);
...
void lily_ts_resolve_as_self(lily_type_stack *);
...
/* This clears N ceiling types. This is useful when doing partial defaulting
   ...
   defaulting. */
void lily_ts_zap_ceiling_types(lily_type_stack *, int);
...
void lily_ts_set_ceiling_type(lily_type_stack *, lily_type *, int);

/* Retrieve a type from past the ceiling. */
lily_type *lily_ts_get_ceiling_type(lily_type_stack *, int);
...
lily_type *lily_ts_build_by_ceiling(lily_type_stack *, lily_class *, int, int);
...
lily_type *lily_ts_build_enum_by_variant(lily_type_stack *, lily_type *);
...
/* This function is called by emitter when it is about to enter a call. The
   ...
   the new ceiling. */
int lily_ts_raise_ceiling(lily_type_stack *, int);
...
/* This function is called when a function has been called. The stack's pos is
   ...
   value. */
void lily_ts_lower_ceiling(lily_type_stack *, int);
...
int lily_ts_count_unresolved(lily_type_stack *);
