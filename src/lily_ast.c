...
void lily_ast_push_method(lily_ast_pool *ap, lily_var *func)
{
...
void lily_ast_push_static_func(lily_ast_pool *ap, lily_var *func)
{
...
void lily_ast_push_boolean(lily_ast_pool *ap, int16_t value)
{
...
void lily_ast_push_variant(lily_ast_pool *ap, lily_variant_class *variant)
{
