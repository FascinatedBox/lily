...
const int opcode_table[][8] = {
    ...
    {o_foreign_call,          5, C_LINENO,         C_READONLY_INPUT, C_COUNT,         C_OUTPUT,        C_COUNT_LIST, -1},
    {o_native_call,           5, C_LINENO,         C_READONLY_INPUT, C_COUNT,         C_OUTPUT,        C_COUNT_LIST, -1},
    {o_function_call,         5, C_LINENO,         C_INPUT,          C_COUNT,         C_OUTPUT,        C_COUNT_LIST, -1},
    ...
    {o_build_list,            4, C_LINENO,         C_COUNT,          C_COUNT_LIST,    C_OUTPUT,        -1,           -1},
    {o_build_tuple,           4, C_LINENO,         C_COUNT,          C_COUNT_LIST,    C_OUTPUT,        -1,           -1},
    ...
    {o_integer_for,           6, C_LINENO,         C_INPUT,          C_INPUT,         C_INPUT,         C_OUTPUT,     C_JUMP},
    {o_for_setup,             5, C_LINENO,         C_INPUT,          C_INPUT,         C_INPUT,         C_INPUT,      -1},
    ...
    {o_get_integer,           3, C_LINENO,         C_INT_VAL,        C_OUTPUT,        -1,              -1,           -1},
    {o_get_boolean,           3, C_LINENO,         C_INT_VAL,        C_OUTPUT,        -1,              -1,           -1},
    {o_get_property,          4, C_LINENO,         C_INT_VAL,        C_INPUT,         C_OUTPUT,        -1,           -1},
    {o_set_property,          4, C_LINENO,         C_INT_VAL,        C_INPUT,         C_INPUT,         -1,           -1},
    {o_push_try,              2, C_LINENO,         C_JUMP,           -1,              -1,              -1,           -1},
    {o_pop_try,               1, C_NOP,            -1,               -1,              -1,              -1,           -1},
    {o_except_catch,          4, C_LINENO,         C_INT_VAL,        C_OUTPUT,        C_JUMP,          -1,           -1},
    {o_except_ignore,         4, C_LINENO,         C_INT_VAL,        C_INT_VAL,       C_JUMP,          -1,           -1},
    {o_raise,                 2, C_LINENO,         C_INPUT,          -1,              -1,              -1,           -1},
    {o_new_instance_basic,    3, C_LINENO,         C_INT_VAL,        C_OUTPUT,        -1,              -1,           -1},
    {o_new_instance_speculative, 3, C_LINENO,         C_INT_VAL,        C_OUTPUT,        -1,              -1,           -1},
    {o_new_instance_tagged,   3, C_LINENO,         C_INT_VAL,        C_OUTPUT,        -1,              -1,           -1},
    {o_optarg_dispatch,       3, C_INT_VAL,        C_COUNT,          C_COUNT_JUMPS,   -1,              -1,           -1},
    ...
    {o_load_class_closure,    4, C_LINENO,         C_INT_VAL,        C_INPUT,         C_OUTPUT,        -1,           -1},
