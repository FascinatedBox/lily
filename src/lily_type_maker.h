...
typedef struct {
    lily_type **types;
    lily_class *function_cls;
    uint16_t pos;
    uint16_t size;
    uint32_t pad;
} lily_type_maker;

lily_type_maker *lily_new_type_maker(lily_class *);
...
lily_type *lily_tm_build_virt_error_type(lily_type_maker *, lily_type *,
        lily_type *);
lily_type *lily_tm_pop(lily_type_maker *);
lily_type *lily_tm_make(lily_type_maker *, lily_class *, uint16_t);
lily_type *lily_tm_make_call(lily_type_maker *, uint16_t, uint16_t);
