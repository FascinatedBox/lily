...
$(AFT_DIR)/aft_main.o: aft_main.c lily_interp.h
...
$(AFT_DIR)/lily_aft_interp.o: lily_interp.c lily_interp.h
	$(CC) $(AFT_CFLAGS) lily_interp.c -o $(AFT_DIR)/lily_aft_interp.o
